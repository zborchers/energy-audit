...

  {
    ...
    groups: [
      ...
      },
      {
        ...
        followupTrigger: { values: ["I'm in pain or discomfort most days"], key: "movement_pain_detail", label: "Where, and how long has it been going on? (optional)" },
      },
      {
        key: "food_drink",
        type: "multiselect",
    ...
    groups: [
      {
        ...
        followupTrigger: { values: ["A place I avoid", "Chaotic"], key: "home_feeling_detail", label: "What makes it feel that way? (optional)" },
      },
      {
